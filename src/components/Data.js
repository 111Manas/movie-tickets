export const homeObject={
  ...
  headLine:'Unlimited Transctions with zero fees.',
  description:'Get access to our Exclusive Dimond Card that allows you to send unlimited Transctions without getting charged any fees.',
